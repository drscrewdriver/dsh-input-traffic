window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*  value for unset sessions so unchanged consumers never re-render. */
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-version-com\mine-dsh-plugins\dsh-input-traffic\src\client\steer-queue-dock.module.css.mjs
		const css$1 = "._7ocDba_dock{width:100%}._7ocDba_panel{background:var(--dsw-alias-bg-layer-1,#fffc);border:1px solid var(--dsw-alias-border-l2,#00000014);border-radius:10px;overflow:hidden}._7ocDba_toolbar{border-bottom:1px solid var(--dsw-alias-border-l2,#0000000f);align-items:center;gap:8px;padding:4px 8px;display:flex}._7ocDba_header{color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:0;align-items:center;gap:6px;padding:2px 6px;font-size:12px;display:inline-flex}._7ocDba_header:disabled{cursor:default}._7ocDba_lead{color:var(--dsw-alias-label-tertiary,#9ca3af);display:inline-flex}._7ocDba_count{font-weight:600}._7ocDba_chevron{color:var(--dsw-alias-label-tertiary,#9ca3af);display:inline-flex}._7ocDba_toolbarActions{margin-left:auto}._7ocDba_clear{color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;align-items:center;gap:4px;padding:3px 8px;font-size:12px;display:inline-flex}._7ocDba_freeze{border:1px solid var(--dsw-alias-border-l3,#0000001f);color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border-radius:6px;align-items:center;gap:4px;padding:3px 8px;font-size:12px;display:inline-flex}._7ocDba_freeze[aria-pressed=true]{border-color:var(--dsw-alias-state-success-primary,#30a46c);color:var(--dsw-alias-state-success-primary,#30a46c)}._7ocDba_freeze:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,#0000000a)}._7ocDba_freeze:disabled{opacity:.5;cursor:default}._7ocDba_frozenBanner{border-bottom:1px solid var(--dsw-alias-border-l2,#0000000f);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#30a46c) 8%, transparent);color:var(--dsw-alias-state-success-primary,#30a46c);padding:4px 10px;font-size:12px}._7ocDba_frozenList{margin:0;padding:4px;list-style:none}._7ocDba_frozenRow{border-radius:6px;align-items:center;gap:8px;padding:4px 6px;display:flex}._7ocDba_frozenMark{color:var(--dsw-alias-label-tertiary,#9ca3af);flex:none;margin-left:auto;font-size:11px}._7ocDba_clear:hover:not(:disabled){border-color:var(--dsw-alias-border-l3,#0000001f);background:var(--dsw-alias-interactive-bg-hover,#0000000a)}._7ocDba_clear:disabled{opacity:.5;cursor:default}._7ocDba_clearConfirm{border-color:var(--dsw-alias-state-error-primary,#e5484d);color:var(--dsw-alias-state-error-primary,#e5484d)}._7ocDba_clearConfirm:hover:not(:disabled){border-color:var(--dsw-alias-state-error-primary,#e5484d);background:color-mix(in srgb, var(--dsw-alias-state-error-primary,#e5484d) 8%, transparent)}._7ocDba_clearCancel{color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;align-items:center;gap:4px;padding:3px 8px;font-size:12px;display:inline-flex}._7ocDba_clearCancel:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,#0000000a)}._7ocDba_clearLabel{font-size:12px}._7ocDba_list{margin:0;padding:4px;list-style:none}._7ocDba_row{border-radius:6px;align-items:center;gap:8px;padding:4px 6px;display:flex}._7ocDba_row[draggable=true]{cursor:grab}._7ocDba_row[draggable=true]:active{cursor:grabbing}._7ocDba_rowDragOver{outline:2px dashed var(--dsw-alias-border-l4,#00000040);outline-offset:-2px;background:var(--dsw-alias-interactive-bg-hover,#0000000d)}._7ocDba_row:hover{background:var(--dsw-alias-interactive-bg-hover,#00000008)}._7ocDba_row[data-editing]{align-items:flex-start}._7ocDba_preview{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary,#1f2937);flex:1;font-size:13px;overflow:hidden}._7ocDba_badge{white-space:nowrap;border-radius:999px;flex:none;align-items:center;gap:4px;padding:1px 6px;font-size:11px;line-height:16px;display:inline-flex}._7ocDba_badgeLabel{color:inherit}._7ocDba_badgeNow{color:var(--dsw-alias-state-error-primary,#e5484d);background:color-mix(in srgb, var(--dsw-alias-state-error-primary,#e5484d) 10%, transparent)}._7ocDba_badgeNext{color:var(--dsw-alias-state-warn-primary,#e8a33d);background:color-mix(in srgb, var(--dsw-alias-state-warn-primary,#e8a33d) 12%, transparent)}._7ocDba_badgeLater{color:var(--dsw-alias-state-success-primary,#30a46c);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#30a46c) 12%, transparent)}._7ocDba_badgeNow ._7ocDba_dot{background:var(--dsw-alias-state-error-primary,#e5484d)}._7ocDba_badgeNext ._7ocDba_dot{background:var(--dsw-alias-state-warn-primary,#e8a33d)}._7ocDba_badgeLater ._7ocDba_dot{background:var(--dsw-alias-state-success-primary,#30a46c)}._7ocDba_steeringList{margin:0;padding:0 4px 4px;list-style:none}._7ocDba_steeringList ._7ocDba_row{opacity:.85}._7ocDba_editor{border:1px solid var(--dsw-alias-border-l3,#00000026);background:var(--dsw-alias-bg-layer-2,#fff);resize:none;border-radius:6px;flex:1;min-width:0;max-height:160px;padding:4px 6px;font-size:13px;line-height:20px;overflow-y:auto}._7ocDba_actions{align-items:center;gap:2px;display:inline-flex}._7ocDba_action{width:24px;height:24px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:pointer;background:0 0;border:0;border-radius:6px;justify-content:center;align-items:center;display:inline-flex}._7ocDba_action:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,#0000000d);color:var(--dsw-alias-label-primary,#1f2937)}._7ocDba_action:disabled{opacity:.4;cursor:default}._7ocDba_plan{border-left:1px solid var(--dsw-alias-border-l2,#00000014);align-items:center;gap:2px;margin-left:4px;padding-left:6px;display:inline-flex}._7ocDba_tier{cursor:pointer;background:0 0;border:1px solid #0000;border-radius:6px;justify-content:center;align-items:center;width:20px;height:20px;padding:0;display:inline-flex}._7ocDba_tier:hover:not(:disabled){border-color:var(--dsw-alias-border-l4,#0003)}._7ocDba_tier:disabled{cursor:default}._7ocDba_tierLater{border-color:var(--dsw-alias-state-success-primary,#30a46c);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#30a46c) 12%, transparent)}._7ocDba_dot{border-radius:50%;width:10px;height:10px}._7ocDba_tierNow ._7ocDba_dot{background:var(--dsw-alias-state-error-primary,#e5484d)}._7ocDba_tierNext ._7ocDba_dot{background:var(--dsw-alias-state-warn-primary,#e8a33d)}._7ocDba_tierLater ._7ocDba_dot{background:var(--dsw-alias-state-success-primary,#30a46c)}";
		...
		var steer_queue_dock_module_css_default = {
			"tierNow": "_7ocDba_tierNow",
			"chevron": "_7ocDba_chevron",
			"action": "_7ocDba_action",
			"tierLater": "_7ocDba_tierLater",
			"steeringList": "_7ocDba_steeringList",
			"frozenRow": "_7ocDba_frozenRow",
			"badge": "_7ocDba_badge",
			"header": "_7ocDba_header",
			"clear": "_7ocDba_clear",
			"rowDragOver": "_7ocDba_rowDragOver",
			"toolbar": "_7ocDba_toolbar",
			"frozenList": "_7ocDba_frozenList",
			"clearCancel": "_7ocDba_clearCancel",
			"frozenBanner": "_7ocDba_frozenBanner",
			"dock": "_7ocDba_dock",
			"panel": "_7ocDba_panel",
			"badgeNext": "_7ocDba_badgeNext",
			"tier": "_7ocDba_tier",
			"count": "_7ocDba_count",
			"clearConfirm": "_7ocDba_clearConfirm",
			"row": "_7ocDba_row",
			"badgeLabel": "_7ocDba_badgeLabel",
			"preview": "_7ocDba_preview",
			"editor": "_7ocDba_editor",
			"clearLabel": "_7ocDba_clearLabel",
			"badgeNow": "_7ocDba_badgeNow",
			"freeze": "_7ocDba_freeze",
			"tierNext": "_7ocDba_tierNext",
			"toolbarActions": "_7ocDba_toolbarActions",
			"dot": "_7ocDba_dot",
			"badgeLater": "_7ocDba_badgeLater",
			"list": "_7ocDba_list",
			"frozenMark": "_7ocDba_frozenMark",
			"plan": "_7ocDba_plan",
			"lead": "_7ocDba_lead",
			"actions": "_7ocDba_actions"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\dsh-version-com\mine-dsh-plugins\dsh-input-traffic\src\client\freeze-button.module.css.mjs
		const css = "._1Ug0ia_freeze{border:1px solid var(--dsw-alias-border-l3,#0000001f);height:24px;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border-radius:6px;align-items:center;gap:4px;padding:0 8px;font-size:12px;display:inline-flex}._1Ug0ia_freeze:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover,#0000000a)}._1Ug0ia_freeze[aria-pressed=true]{border-color:var(--dsw-alias-state-success-primary,#30a46c);color:var(--dsw-alias-state-success-primary,#30a46c);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#30a46c) 8%, transparent)}._1Ug0ia_label{font-size:12px}";
		...
		*/
		function FreezeButton({ useSession, updateQueue, cancel, send, sendSteer, sessionId, setComposerBlock, notify, t }) {
			const sid = sessionId ?? "";
